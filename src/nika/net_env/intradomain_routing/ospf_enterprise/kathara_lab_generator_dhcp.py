...
OSPF_UTILS = os.path.join(PROJECT_ROOT, "src/nika/net_env/utils/ospf")
WEB_UTILS = os.path.join(PROJECT_ROOT, "src/nika/net_env/utils/web")
...
def generate_ospf_enterprise_dhcp_topology(
    ...
    lb_meta.extra_files["/etc/nginx/nginx.conf"] = _read_file(os.path.join(SCRIPT_DIR, "nginx.conf"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate Kathara lab config for OSPF Enterprise DHCP")
