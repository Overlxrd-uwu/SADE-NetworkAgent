...
class BGPAclBlockBase:
    ...
    def __init__(self, scenario_name: str | None, target_device: str | None = None, **kwargs):
        ...
        if target_device and target_device in self.net_env.routers:
            self.faulty_devices = [target_device]
        else:
...
class ARPAclBlockBase:
    ...
    def __init__(self, scenario_name: str | None, target_device: str | None = None, **kwargs):
        ...
        self.kathara_api = KatharaAPIALL(lab_name=self.net_env.lab.name)
        self.injector = FaultInjectorBase(lab_name=self.net_env.lab.name)
        all_devices = self.net_env.routers + self.net_env.hosts
        if target_device and target_device in all_devices:
            self.faulty_devices = [target_device]
        else:
...
class IcmpAclBlockBase:
    ...
    def __init__(self, scenario_name: str | None, target_device: str | None = None, **kwargs):
        ...
        if target_device and target_device in all_devices:
            ...
            self.faulty_devices = [random.choice(all_devices)]
...
class DNSPortBlockedBase:
    ...
    def __init__(self, scenario_name: str | None, target_device: str | None = None, **kwargs):
        ...
        self.kathara_api = KatharaAPIALL(lab_name=self.net_env.lab.name)
        self.injector = FaultInjectorBase(lab_name=self.net_env.lab.name)
        if target_device and target_device in self.net_env.servers.get("dns", []):
            self.faulty_devices = [target_device]
        else:
